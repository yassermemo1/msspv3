...
- Name: Client Management E2E Tests >> should validate form fields and show error messages
- Location: /Users/yasseralmohammed/Documents/MsspClientManager/tests/e2e/client-management.spec.ts:219:3
...
Call log:
  - navigating to "http://localhost:5000/", waiting until "load"
    ...
    at /Users/yasseralmohammed/Documents/MsspClientManager/tests/e2e/client-management.spec.ts:10:16
```
...
- paragraph:
  - text: http://localhost:5000/ sent back an error.
