...
DROP DATABASE IF EXISTS mssp_production;
--
-- Name: mssp_production; Type: DATABASE; Schema: -; Owner: mssp_user
--

CREATE DATABASE mssp_production WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'C';


ALTER DATABASE mssp_production OWNER TO mssp_user;

\connect mssp_production
