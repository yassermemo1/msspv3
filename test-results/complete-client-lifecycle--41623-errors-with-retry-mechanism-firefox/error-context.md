...
- Name: Error Handling and Edge Cases >> Handles network errors with retry mechanism
- Location: /Users/yasseralmohammed/Documents/MsspClientManager/tests/e2e/complete-client-lifecycle.spec.ts:410:3
...
Call log:
  - navigating to "http://localhost:5000/login", waiting until "load"
    ...
    at login (/Users/yasseralmohammed/Documents/MsspClientManager/tests/e2e/complete-client-lifecycle.spec.ts:47:14)
    at /Users/yasseralmohammed/Documents/MsspClientManager/tests/e2e/complete-client-lifecycle.spec.ts:390:11
```
...
- paragraph:
  - text: http://localhost:5000/login sent back an error.
  - paragraph: "Error code: 403 Forbidden"
- paragraph
- list:
