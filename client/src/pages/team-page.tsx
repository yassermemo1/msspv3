...
export default function TeamPage() {
  ...
  const handleDeleteTeamMember = (memberId: string) => {
    if (confirm('Are you sure you want to remove this team member?')) {
      toast({
        ...
        description: `Team member ${memberId} has been removed.`
      });
  ...
  const handleViewProfile = (memberId: string) => {
    toast({
      title: "View Profile",
      description: `Opening profile for team member ${memberId}...`
    });
  ...
  const handleSendMessage = (memberId: string) => {
    toast({
      title: "Send Message",
      description: `Opening message composer for team member ${memberId}...`
    });
