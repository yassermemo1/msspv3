...
export default function ClientDetailPage() {
  ...
  const getStatusColor = (status: string) => {
    switch (status?.toLowerCase()) {
      ...
      case "needs assessment": return "bg-blue-100 text-blue-800 border-blue-200";
      case "active - onboarding": return "bg-green-100 text-green-800 border-green-200";
      case "active - operational": return "bg-green-100 text-green-800 border-green-200";
